...
@Component({
  ...
  <div class="tabs">
    <ul class="tab-group">
      <li *ngFor="let tab of tabs; let i=index" (click)="activeTab(i)" class="tab" [class.active]="tab.active">
...
export class AppComponent {
  ...
  activeTab(index: number) {
    ...
    this.tabs = this.tabs.map((tab, i) => i === index ? { ...tab, active: true } : { ...tab, active:true })
  }
}
